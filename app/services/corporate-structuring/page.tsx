...
export default function CorporateStructuringPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: t("breadcrumb.corporateStructuring") },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-[120px] py-12">
        <Breadcrumb items={breadcrumbItems} />

        {/* Main Title */}
        <h1 className="text-[#2d3748] font-poppins text-[54px] font-semibold leading-[56px] mb-8">
          {t("page.title")}
        </h1>

        {/* Description */}
        <p className="text-[#4a5568] font-inter text-base leading-[19px] mb-12 max-w-4xl">
          {t("page.description")}
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[#2d3748] font-inter text-2xl font-normal leading-[26px]">
                {t("page.services.corporateStructuring.title")}
              </h2>
              <p className="text-[#4a5568] font-inter text-base leading-[19px]">
                {t("page.services.corporateStructuring.description")}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[#2d3748] font-inter text-2xl font-normal leading-[26px]">
                {t("page.services.incorporation.title")}
              </h2>
              <div className="text-[#4a5568] font-inter text-base leading-[19px]">
                <p className="mb-2">
                  {t("page.services.incorporation.description")}
                </p>
                <p className="mb-1">
                  {t("page.services.incorporation.locations.intro")}
                </p>
                <div className="space-y-1">
                  <div>{t("page.services.incorporation.locations.eu")}</div>
                  <div>{t("page.services.incorporation.locations.cis")}</div>
                  <div>{t("page.services.incorporation.locations.serbia")}</div>
                  <div>{t("page.services.incorporation.locations.uk")}</div>
                  <div>{t("page.services.incorporation.locations.usa")}</div>
                  <div>{t("page.services.incorporation.locations.uae")}</div>
                  <div>
                    {t("page.services.incorporation.locations.hongkong")}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[#2d3748] font-inter text-2xl font-normal leading-[26px]">
                {t("page.services.bankAccount.title")}
              </h2>
              <p className="text-[#4a5568] font-inter text-base leading-[19px]">
                {t("page.services.bankAccount.description")}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[#2d3748] font-inter text-2xl font-normal leading-[26px]">
                {t("page.services.governance.title")}
              </h2>
              <p className="text-[#4a5568] font-inter text-base leading-[19px]">
                {t("page.services.governance.description")}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[#2d3748] font-inter text-2xl font-normal leading-[26px]">
                {t("page.services.investment.title")}
              </h2>
              <p className="text-[#4a5568] font-inter text-base leading-[19px]">
                {t("page.services.investment.description")}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <h2 className="text-[#2d3748] font-inter text-2xl font-normal leading-[26px]">
                {t("page.services.specialPrograms.title")}
              </h2>
              <p className="text-[#4a5568] font-inter text-base leading-[19px]">
                {t("page.services.specialPrograms.description")}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <ContactForm
            title={t("contact.service.title")}
            subtitle={t("contact.service.subtitle")}
          />
        </div>
      </div>
