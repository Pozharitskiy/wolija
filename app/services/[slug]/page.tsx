...
export default function ServicePage() {
  ...
  const serviceData = {
    "corporate-structuring": {
      ...
      heroImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/bfefd954787690e3c77dee02f1a22fea654b8ad7?width=3840",
      services: [
        {
          title: t("page.services.corporateStructuring.title"),
          description: t("page.services.corporateStructuring.description"),
        },
        {
          title: t("page.services.incorporation.title"),
          description: t("page.services.incorporation.description"),
        },
        {
          title: t("page.services.bankAccount.title"),
          description: t("page.services.bankAccount.description"),
        },
      ],
      advantages: [
        t("services.advantages.corporate.point1"),
        t("services.advantages.corporate.point2"),
        t("services.advantages.corporate.point3"),
        t("services.advantages.corporate.point4"),
      ],
    },
    "legal-consulting": {
      ...
      heroImage:
        "https://api.builder.io/api/v1/image/assets/TEMP/legal-consulting.jpg?width=3840",
      services: [
        {
          title: t("services.legal.contract.title"),
          description: t("services.legal.contract.description"),
        },
        {
          title: t("services.legal.compliance.title"),
          description: t("services.legal.compliance.description"),
        },
        {
          title: t("services.legal.litigation.title"),
          description: t("services.legal.litigation.description"),
        },
      ],
      advantages: [
        t("services.advantages.legal.point1"),
        t("services.advantages.legal.point2"),
        t("services.advantages.legal.point3"),
        t("services.advantages.legal.point4"),
      ],
    },
  ...
  const relatedProjects = [
    {
      title: t("projects.related.fintech.title"),
      description: t("projects.related.fintech.description"),
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/fintech-project.jpg?width=400",
      slug: "fintech-startup-structure",
      category: t("projects.categories.fintech"),
    },
    {
      title: t("projects.related.ecommerce.title"),
      description: t("projects.related.ecommerce.description"),
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/ecommerce-project.jpg?width=400",
      slug: "ecommerce-expansion",
      category: t("projects.categories.ecommerce"),
    },
    {
      title: t("projects.related.saas.title"),
      description: t("projects.related.saas.description"),
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/saas-project.jpg?width=400",
      slug: "saas-global-structure",
      category: t("projects.categories.saas"),
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {/* Main Title */}
        <h1 className="text-[#2d3748] font-poppins text-5xl font-semibold leading-tight mb-8">
          {currentService.title}
        </h1>

        {/* Description */}
        <p className="text-[#4a5568] font-inter text-lg leading-relaxed mb-12 max-w-4xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          {/* Services List */}
          <div>
            <h2 className="text-[#2d3748] font-poppins text-3xl font-semibold mb-8">
              {t("service.sections.services")}
            </h2>
            <div className="space-y-8">
              {currentService.services.map((service, index) => (
                <div key={index} className="flex flex-col gap-3">
                  <h3 className="text-[#2d3748] font-inter text-xl font-semibold leading-6">
                    {service.title}
                  </h3>
        ...
        <div className="mb-16">
          <h2 className="text-[#2d3748] font-poppins text-3xl font-semibold mb-8">
            {t("service.sections.relatedProjects")}
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <ContactForm
            title={t("service.contact.title")}
            subtitle={t("service.contact.subtitle")}
          />
        </div>
      </div>
