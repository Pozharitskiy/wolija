  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {/* Team Section */}
        <div className="mb-16">
          <h1 className="font-poppins text-4xl font-bold text-[#2d3748] mb-6">
            {t("team.title")}
          </h1>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-inter text-sm font-semibold text-[#2d3748]">
                        Projects
                      </span>
                      <div className="bg-[#84cc16] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">
                        {member.projects}
                      </div>
                    </div>
                  </div>
        ...
        <div className="text-center mb-8">
          <h2 className="font-poppins text-3xl font-bold text-[#2d3748] mb-4">
            {t("team.contact.title")}
          </h2>
          <p className="font-inter text-lg text-[#4a5568] max-w-3xl mx-auto mb-8">
